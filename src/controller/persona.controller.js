...
const postPersona = async (req, res) => {
    try {
        ...
        const connection = await getConnection();
        await connection.query(`INSERT INTO Estudiante VALUES (${idPersona}, '${Nombre}', '${Apel1}', '${Apel2}', '${cedula}', '${email}', ${Roll_idRol}, '${contacto}', '${nacionalidad}', '${edad}', '${genero}', '${sexo}', ${Direccion_id_Direccion})`);
        res.status(200).json(new BaseResponse(
            "Personas", 
